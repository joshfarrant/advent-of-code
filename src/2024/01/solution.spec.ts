...
describe('day 01', () => {
  describe('part 01', () => {
    describe.each([['solution', part1Solution]])('%s', (_, solution) => {
      test('example input', () => {
        expect(solution(exampleInput)).toBe(11);
      });

      test('real input', () => {
        expect(solution(actualInput)).toBe(3246517);
      });
    });
  });
  ...
  describe('part 02', () => {
    describe.each([['solution', part2Solution]])('%s', (_, solution) => {
      test('example input', () => {
        expect(solution(exampleInput)).toBe(31);
      });

      test('real input', () => {
        expect(solution(actualInput)).toBe(29379307);
      });
    });
  });
});
