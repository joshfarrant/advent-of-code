...
describe('day 01', () => {
  describe('part 01', () => {
    describe.each([['solution', part1Solution]])('%s', (_, solution) => {
      test('example input', () => {
        expect(solution(exampleInput)).toBe(357);
      });

      test('real input', () => {
        expect(solution(actualInput)).toBe(17493);
      });
    });
  });
  ...
  describe('part 02', () => {
    describe.each([['solution', part2Solution]])('%s', (_, solution) => {
      test('example input', () => {
        expect(solution(exampleInput)).toBe(3121910778619);
      });

      test('real input', () => {
        expect(solution(actualInput)).toBe(173685428989126);
      });
    });
  });
});
